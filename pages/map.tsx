        ...
        <>
            ...
            >
                <Container maxWidth='lg'>
                    ...
                    <Box 
                        component="iframe"
                        src={`http://localhost:5000/leaflet.php?x=${coordinates[district as keyof typeof coordinates].x}&y=${coordinates[district as keyof typeof coordinates].y}&z=${coordinates[district as keyof typeof coordinates].z}`}
